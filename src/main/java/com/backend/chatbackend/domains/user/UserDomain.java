package com.backend.chatbackend.domains.user;
...
public class UserDomain {
    ...
    private UserDomain(@NotBlank String firstName, @NotBlank String lastName, @NotBlank @Email String email, @NotBlank String password) {
